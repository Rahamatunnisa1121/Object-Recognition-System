...
#main configuration
st.title("🔍 YOLO Object Segmentation Sytem")
if mode=="Image":
    st.header("🖼️ Image Segmentation")
    ...
    if uploaded_image is not None:
        ...
        st.image(annotated_image,channels='BGR',caption='Segmentation Result')
elif mode=="Video":
    ...
    st.header("📷 Live Webcam Segmentation")
